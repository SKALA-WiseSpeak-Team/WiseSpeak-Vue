<script setup lang="ts">
  ...
  const t = (key: string) => {
    const translations: Record<string, string> = {
      'create.title': '새 강의 만들기',
      'create.description':
        'PDF 문서를 업로드하여 인터랙티브 음성 강의를 생성하세요.',
      'create.uploadPDF': 'PDF 문서 업로드',
      'create.dragDrop': '여기에 파일을 끌어다 놓으세요',
      'create.orClick': '또는 클릭하여 파일 선택',
      'create.selectPDF': 'PDF 파일 선택',
      'create.maxFileSize100': '최대 파일 크기: 100MB',
      'create.uploaded': '업로드됨',
      'create.remove': '삭제',
      'create.errorPdfOnly': 'PDF 파일만 업로드 가능합니다.',
      'create.errorFileSize': '파일 크기는 100MB 이하여야 합니다.',
      'create.lectureInfo': '강의 정보',
      'create.lectureTitle': '강의 제목',
      'create.titlePlaceholder': '강의 제목을 입력하세요',
      'create.descriptionPlaceholder': '강의에 대한 설명을 입력하세요',
      'create.voiceType': '음성 유형',
      'create.back': '이전',
      'create.next': '다음',
      'create.saveForLater': '나중에 저장',
      'create.generateLecture': '강의 생성하기',
      'create.generating': '강의 생성 중...',
      'create.analyzingPDF': 'PDF 파일 분석 중...',
      'create.generatingAudio': '오디오 생성 중...',
      'create.preparingInteractive': '인터랙티브 요소 준비 중...',
      'create.finalizing': '마무리 중...',
      'create.success': '성공!',
      'create.successMessage': '[title] 강의가 성공적으로 생성되었습니다!',
      'create.viewLecture': '강의 보기',
      'create.returnToGallery': '갤러리로 돌아가기',
      'create.errorGenerating': '강의 생성 중 오류가 발생했습니다.'
    };
